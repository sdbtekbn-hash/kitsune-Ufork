package io.github.huskydg.magisk.core.download
...
import io.github.huskydg.magisk.core.JobService
import io.github.huskydg.magisk.core.R
import io.github.huskydg.magisk.core.base.IActivityExtension
import io.github.huskydg.magisk.core.cmp
import io.github.huskydg.magisk.core.di.ServiceLocator
import io.github.huskydg.magisk.core.intent
import io.github.huskydg.magisk.core.ktx.set
import io.github.huskydg.magisk.core.utils.ProgressInputStream
...
class DownloadEngine(session: DownloadSession) : DownloadSession by session, DownloadNotifier {
    ...
    companion object {
        const val ACTION = "io.github.huskydg.magisk.DOWNLOAD"
        ...
        private fun createBroadcastIntent(context: Context, subject: Subject) =
            context.intent<io.github.huskydg.magisk.core.Receiver>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)

        private fun createServiceIntent(context: Context, subject: Subject) =
            context.intent<io.github.huskydg.magisk.core.Service>()
                .setAction(ACTION)
                .putExtra(SUBJECT_KEY, subject)
